...
const SEOHead = ({ 
  title = "NK Board Game - ร้านบอร์ดเกม อันดับ 1 ในใจ Gen Z | บางแค ศรีนครินทร์ สามย่าน โลตัส บางแค",
  description = "NK Board Game ร้านบอร์ดเกมอันดับ 1 ในใจชาว Gen Z พร้อมบริการครบครัน 4 สาขา บางแค ศรีนครินทร์ สามย่าน โลตัส บางแค เกมกว่า 1000+ เกม",
  keywords = "ร้านบอร์ดเกม, บอร์ดเกม, ปาร์ตี้เกม, การ์ดเกม, NK Board Game, บางแค, ศรีนครินทร์, สามย่าน, โลตัส บางแค",
