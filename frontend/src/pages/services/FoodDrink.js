  ...
  return (
    <div className="service-detail-page">
      <SEOHead 
        ...
        description={isEnglish ? "NK Café at NK Board Game - Various food and drinks perfect for gaming. Fresh ingredients, clean, safe. Butter toast, snacks, beverages, smoothies, rice dishes. Starting from 29 Baht. 4 branches: Bangkae, Srinakarin, Samyan, Phra Nakhon." : "NK Café ที่ NK Board Game เมนูอาหารและเครื่องดื่มหลากหลาย เหมาะสำหรับเติมพลังขณะเล่นเกม วัตถุดิบสด สะอาด ปลอดภัย ขนมปังเนย ของทานเล่น เครื่องดื่ม สมูทตี้ เมนูข้าว เริ่มต้น 29 บาท 4 สาขา บางแค ศรีนครินทร์ สามย่าน พระนคร ซีคอนบางแค ซีคอนศรีนครินทร์ สามย่านมิตรทาวน์ ปากคลองตลาด"}
        keywords={isEnglish ? "NK Café, Board Game Café, Food while Gaming, Café Menu, Butter Toast, Smoothies, Rice Dishes, Beverages, NK Board Game, Bangkae, Srinakarin, Samyan, Phra Nakhon" : "NK Café, ร้านกาแฟ, อาหารขณะเล่นเกม, เมนูคาเฟ่, ขนมปังเนย, สมูทตี้, เมนูข้าว, เครื่องดื่ม, NK Board Game, บางแค, ศรีนครินทร์, สามย่าน, พระนคร, ซีคอนบางแค, ซีคอนศรีนครินทร์, สามย่านมิตรทาวน์, ปากคลองตลาด"}
