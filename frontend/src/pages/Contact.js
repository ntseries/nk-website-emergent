...
const Contact = () => {
  ...
  return (
    <div className="contact-page">
      <SEOHead 
        title={isEnglish ? "Contact Branches - NK Board Game | Board Game Shop Bangkae Srinakarin Samyan Phra Nakhon" : "ติดต่อสาขา - NK Board Game | ร้านบอร์ดเกม บางแค ศรีนครินทร์ สามย่าน พระนคร"}
        ...
        keywords={isEnglish ? "Contact Branches, Board Game Shop Bangkae, Board Game Shop Srinakarin, Board Game Shop Samyan, Board Game Shop Phra Nakhon, Board Game Shop near BTS, Seacon Bangkae, Seacon Square, Samyan Mitrtown, Pak Klong Talad, NK Board Game" : "ติดต่อสาขา, ร้านบอร์ดเกม บางแค, ร้านบอร์ดเกม ศรีนครินทร์, ร้านบอร์ดเกม สามย่าน, ร้านบอร์ดเกม พระนคร, ร้านบอร์ดเกม ติดรถไฟฟ้า, ซีคอนบางแค, ซีคอนศรีนครินทร์, สามย่านมิตรทาวน์, ปากคลองตลาด, NK Board Game"}
