  ...
  return (
    <div className="about-page">
      <SEOHead 
        ...
        description={isEnglish ? "The story of NK Board Game - Thailand's #1 board game shop for Gen Z. Founded in 2023, over 60,000+ members. Board game shops in Bangkae, Srinakarin, Samyan, Lotus Bangkae. 4 branches. 35 team members." : "เรื่องราวของ NK Board Game ร้านบอร์ดเกมอันดับ 1 ในใจชาว Gen Z ก่อตั้งปี 2023 สมาชิกกว่า 60,000+ คน ร้านบอร์ดเกมบางแค ศรีนครินทร์ สามย่าน โลตัส บางแค 4 สาขา ทีมงาน 35 คน"}
        keywords={isEnglish ? "About Us, NK Board Game, Board Game Shop, Company History, Team, Board Games, Gen Z, 2023, Thailand" : "เกี่ยวกับเรา, NK Board Game, ร้านบอร์ดเกม, ประวัติร้าน, ทีมงาน, บอร์ดเกม, Gen Z, 2023, ซีคอนบางแค, ซีคอนศรีนครินทร์, สามย่านมิตรทาวน์, โลตัส บางแค"}
      ...
      <section className="team-section" style={{paddingBottom: '60px'}}>
        <div className="container">
          ...
          <div className="team-grid">
            ...
            <div className="team-member">
              <div className="member-avatar">
                <img src="https://nkboardgame-web-production.s3.ap-southeast-1.amazonaws.com/Team-Dream.jpeg" alt="Dream" />
              </div>
              <h3 className="member-name">Dream</h3>
              <p className="member-role">Support</p>
              <p className="member-gen">NK New Gen</p>
            </div>
          </div>
